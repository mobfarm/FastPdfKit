...
typedef struct MFProfile {
	...
	unsigned int fpdfk_xtr_policy[4];
	...
	unsigned int fpdfk_src_policy[4];
	
} MFProfile;

void initProfile(MFProfile * profile);
void initProfileWithSettings(MFProfile * profile, int xtr0, int xtr1, int xtr2, int xtr3, int src0, int src1, int src2, int src3);
